...
import { forgotPassword } from '../features/adminSlice';
...
const ForgotPassword = () => {
  ...
  const [timerRunning, setTimerRunning] = useState(true);
      ...
      useEffect(()=>{
          if(adminState.forgotPasswordSuccess){
              navigate("/login");
          }
      });
...
<Snackbar
      ...
      <DialogActions>
        <Button  variant="contained" style={{ backgroundColor: 'blue', color: 'white', height: '55px' }} fullWidth onClick={handleResetPassword}>
       Update Password
        </Button>
        <Button
          fullWidth
