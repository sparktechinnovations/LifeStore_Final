      ...
      <Container>
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Stack direction={'row'} gap={2}>
            ...
            <Button variant="contained" component={Link} to="/dashboard/import" style={{ backgroundColor: 'black' }}>
             Bulk Import
            </Button>
                ...
                <TableBody style={{ backgroundColor: 'white', cursor: 'pointer' }}>
                  {productState?.productListLoader ? (
                    ...
                    productState?.products.map((product, index) => {
                      const { _id, productName, productId, productPrice,hsnNumber,lifestoreDiscount } = product;
                      ...
                      return (
                        <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={selectedProduct}>
                          ...
                          <TableCell
                            ...
                            align="center"
                            component={Link}
                            to={`/dashboard/productProfile/${_id}`}
                          >
                            {productName}
                          </TableCell>
                          <TableCell align="center" component={Link} to={`/dashboard/productProfile/${_id}`}>
