...
const TABLE_HEAD = [
    {id:"si",label:"Sl.No",alignRight:false},
                ...
                <TableBody style={{ backgroundColor: 'white', cursor: 'pointer' }}>
                  {invoiceState?.invoiceListLoader ? (
                    ...
                    invoiceState?.invoices.map((invoice, index) => {
                      const { _id, invoiceNum, amount, createdAt, customer, agent } = invoice;
                      ...
                      return (
                        <TableRow
                          ...
                          onClick={() => {
                            if(invoice.invoiceInfo){
                              window.open(invoice.invoiceInfo, '_');
                            }else{
                        ...
                        >
                          <>
                            ...
                            <TableCell align="center">{agent?.name || 'N/A'}</TableCell>
                          </>
                        </TableRow>
                      );
                    })
