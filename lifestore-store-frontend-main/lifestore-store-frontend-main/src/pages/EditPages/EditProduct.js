...
import { Grid, Card, CardContent, Typography, Button, TextField, Box, Alert, Stack, FormControlLabel, Checkbox, Snackbar } from '@mui/material';
  ...
  useEffect(() => {
    if (product && product?.product && getProductSuccess) {
      setFormData((prevData) => ({
        ...
        hsnNumber:product?.product?.hsnNumber,
        lifestoreDiscount:product?.product?.lifestoreDiscount,
